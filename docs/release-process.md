...
5. `release.yml` runs again, publishes the new version to npm, and creates the matching Git tag and GitHub Release after confirming the exact version exists on `registry.npmjs.org`
