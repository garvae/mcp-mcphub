...
export const PINNED_RELEASE_TARGET_VERSION = '1.0.39';
export const MINIMUM_BEST_EFFORT_VERSION = '1.0.15';
export const PINNED_RELEASE_TARGET_HAS_ROUTE_SNAPSHOT = false;
export const AUTOMATED_COMPATIBILITY_IMAGE_TAGS = ["1.0.15","1.0.39","latest"] as const;
...
export const COMPATIBILITY_NOTES_SUMMARY = 'The weekly pinned release target is `1.0.39`; if no dedicated route snapshot is committed yet, container smoke tests still cover runtime compatibility.';
